    ...
    public function action_poll() {
        ...
        switch ($val) {
            case 'list_poll':
                ...
                $view->all_items = ORM::factory('Voteitem')->all_items();
                $this->template->content = $view;
                break;
            case 'edit_poll':
    ...
    public function action_catalog() {
        ...
        switch ($val) {
            ...
            case 'list_categories':
                ...
                $seo_box = View::factory('admin/seo/seo_box');
                $kdst = ORM::factory('Categories')->seo($action);
                $seo_box->seo = $kdst;
                $view->modal = $modal;
            ...
            case 'list_products':
                ...
                $count = $model_sub_categories->detect_sp($level3);
                if ($count >= 1) {
...
//                    if () {
                    ...
                    $product = ORM::factory('Products')->product_main_info($level2, $level3, null);
...
//    }
    ...
    public function action_seo_update() {
        if ($this->request->post()) {
