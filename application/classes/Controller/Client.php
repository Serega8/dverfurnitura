...
class Controller_Client extends Controller_Template {
    ...
    public function before()
    {
        ...
        $styles = array(
            'content/css/style.css?ver=1.5',
        );
        $scripts = array(
            'content/js/jquery-1.8.2.min.js',
            'content/js/jquery.carouFredSel-6.2.1-packed.js',
            'content/js/slider_mini.js',
            'content/js/accordion.js',
        );
    ...
    public function action_catalog()
    {
        ...
        switch ($val)
        {
            ...
            case 'list_products':
                ...
                $model_products = ORM::factory('Products');
                $model_sub_categories = ORM::factory('Subcategories');
                $model_brands = ORM::factory('Brands');

                $all_brands = $model_brands->list_brands();
                ...
                if ($count >= 1)
                {
                    ...
                    $brands = ORM::factory('Brands')->list_brands();
                    ...
                    $view->level2 = $level2;
                    $view->level3 = $level3;
                    $view->all_brands = $all_brands;
                    $all_sub_categories = $model_sub_categories->list_sub_categories($level2, true);
                    $view->sub_menu = $all_sub_categories;
                    $view->products = $all_products;
                    $view->brands = $this->clean_empty_brands($brands, $all_products);
    ...
    public function emptybrands($brands, $products)
    {

        $br = array();
        //if($brands['translit'] === $_SERVER_URI)
...
//        return $br;   
    ...
    public function clean_empty_brands($brands, $products)
    {
        $clean_brands = array();
