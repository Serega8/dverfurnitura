    ...
    function upload_f(e) {
        ...
        if (files.length) {
            ...
            var upload = function() {
                ...
                var url = '/admin/add_product_all_info';
            ...
            req.open("POST", "/admin/add_product_all_info", true);
...
<div id="product_information">
    <div id="info">
        <p style='font-size:18px;padding-top:20px;'>Добавление нового товара</p>
        <div id="image_product_info">
            <div id="big_img">
                <img class="big_img" src="" alt="" title=""/>
            </div>
            <div id="small_imgs"> 
        ...
        <div id="text_product_info">
            <div>
                <input placeholder='Название товара' type="text" id="name" value="<?= $info['name']; ?>"/>
                ...
                <div>
                    <p>
                        <textarea id="descr" placeholder='Описание товара'><?= $info['descr']; ?></textarea>
                    </p> 
                    <div id="table_product_info">
                        ...
                        <button id="apply_btn">Добавить</button>
                    </div>
                </div>
