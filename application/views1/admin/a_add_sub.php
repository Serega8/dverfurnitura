...
<script>
    ...
    function upload() {
        ...
        data.append('level2', h);
        data.append('name', name.value);
        var url = '/admin/addSub'
...
<div id="goods" style='background: none;'>
        <div class="goods_images" style="height:400px;">
            <p><input type="text" id="name" placeholder='Название подкатегории' name="sub_cat_nam" value=""></p>
                <img style="margin-top:60px;"  src="/content/img/empty.jpeg" alt=""/>
                <input id="cat_img" style="margin-top:50px;" name="file" type="file"/>
                <input type="hidden" id="hinput" value="<?=$level2;?>"/>
        </div>
    <button style="margin-top:460px;" id="apply">Добавить</button>
